...
parser = argparse.ArgumentParser(
	...
	epilog="Author: Andrew Mason; Release: 18/02/16; Contact: andrew.mason@roslin.ed.ac.uk")
...
subprocess.call("python /groups2/avian_genomes/chicken_erv/04_avian_lineage_LTR_retrotransposon_full_analysis/00_pipeline/001_seq_extract.py -u --prefix " + (usr_args.LH_out).split(".")[0] + " " + (usr_args.LH_out).split(".")[0] + "_positions.txt " + usr_args.ref, shell=True)
